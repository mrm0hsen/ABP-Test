...
public class BookStoreHttpApiHostModule : AbpModule
{
    ...
    private void ConfigureConventionalControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            ...
            options.ConventionalControllers.Create(typeof(OrganChartApplicationModule).Assembly);
            options.ConventionalControllers.Create(typeof(EmployeeApplicationModule).Assembly, opt =>
            {
                opt.RootPath = EmployeeRemoteServiceConsts.ModuleName;
                opt.RemoteServiceName = EmployeeRemoteServiceConsts.RemoteServiceName;
            });
        });
    }
